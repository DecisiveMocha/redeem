...
class TestTMC2130_SingleStepper(unittest.TestCase):
  ...
  def test_initialize_register(self):
    ...
    # chopconf has diss2g, intpol, mres=4, vsense, tbl=2, toff=5
        mock.call([0x80 | 0x6C, 0x54, 0x03, 0x0, 0x05]),
    # coolconf has sgt=0xf, semax=2, semin=1
        mock.call([0x80 | 0x6D, 0x0, 0x0f, 0x02, 0x01]),
